...
//
-(void) loadRewardedInterstitialAdWithSDK:(NSString *)sdk {
    ...
    if([sdk isEqualToString:@"AdMob"] ) {
                ...
                [[GADRewardBasedVideoAd sharedInstance] loadRequest:[GADRequest request]
                                                       withAdUnitID:ADMOB_HASH_GAD_INTER_REWARDED];
...
- (NSInteger)collectionView:(UICollectionView *)view numberOfItemsInSection:(NSInteger)section {
    ...
    if([_sdkName isEqualToString:@"AdMob"] ) return ADS_TYPE_NUM+1;
    return ADS_TYPE_NUM;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.item) {
            ...
            case MFAdTypeRewardedInterstitial:
            
            [self loadRewardedInterstitialAdWithSDK:_sdkName];
            _nativeAdView.hidden = true;
