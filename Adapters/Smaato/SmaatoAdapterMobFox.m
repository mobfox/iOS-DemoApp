...
- (void)loadBanner {
    ...
    self.banner = [[MobFoxTagAd alloc] init:inv_h withFrame:CGRectMake(0, 0, self.network.width, self.network.height)];
...
- (void)loadInterstitial {
    ...
    self.interstitial = [[MobFoxTagInterstitialAd alloc] init:inv_h];
